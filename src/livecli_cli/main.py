...
def setup_plugin_options():
    ...
    if args.afreeca_username:
        livecli.set_plugin_option("afreeca", "username", args.afreeca_username)
    ...
    if args.abweb_username:
        livecli.set_plugin_option("abweb", "username", args.abweb_username)
    ...
    if abweb_password:
        livecli.set_plugin_option("abweb", "password", abweb_password)
    ...
    if args.resolve_blacklist_path:
